Public Class uc_test_customctr
    ...
    Public Property DataName As String
        ...
        End Get
    End Property
    Public Property DataInfo As String
        Set(value As String)
            in_info.Text = value
        End Set
        Get
    ...
    Private Sub SetupUserControl()
        ...
        For Each _ctr As Control In {lbl_id, in_name, in_info}
            _ctr.Text = ""
    ...
    Private Sub GetData(DataID As String)
        Me.DataName = "Test Name"
        Me.DataInfo = "TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT"
    End Sub
